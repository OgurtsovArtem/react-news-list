...
import { AUTH_MODAL_ID, DONE_LOGIN_MODAL_ID, DONE_REGISTR_MODAL_ID } from "../lib/names";
  ...
  return (
    <>
      ...
      {currentModal?.id === DONE_REGISTR_MODAL_ID && (
        <Done id={DONE_REGISTR_MODAL_ID} title={DONE_REGISTR_MODAL_TITLE} buttonText={"войти"} />
      )}
