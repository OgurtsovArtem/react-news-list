        ...
        <section className={clsx('container', style.about)}>
            ...
            <div className={style.description}>
                ...
                <p className={style.text}>
                    Это небольшой Pet-проект для закрепления и объединения
                    знаний с двух курсов - Web-разработчик и React-разработчик
                    от Yandex Praktikum
                </p>
                <p className={style.text}>
                    В данной работе использован стек MERN{' '}
                ...
                <p className={style.text}>
                    ...
                    <span className={style.accent}>Cypress</span>{' '}
                    <span className={style.accent}>Jest</span>
                </p>
            </div>
        </section>
    );
