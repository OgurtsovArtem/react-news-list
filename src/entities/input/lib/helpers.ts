...
export const checkName = (value: string): boolean =>
    regExpName.test(String(value));
export const checkPassword = (value: string): boolean =>
    regExpPassword.test(String(value));
export const checkMinLength = (value: string, limiter: string): boolean =>
    value < limiter;
export const checkMaxLength = (value: string, limiter: string): boolean =>
    value > limiter;
